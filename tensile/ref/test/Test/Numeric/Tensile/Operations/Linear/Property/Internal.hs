...
import Numeric.Tensile.Operations.Linear.Internal (transpose')
...
pred_transposition t = False -- t == (f . f $ t)
  where --r :: Perm 3
        --r = reversal'
...
- merge src & test trees of lib and ref?
- create tensile-reference lib & testsuite?
-
